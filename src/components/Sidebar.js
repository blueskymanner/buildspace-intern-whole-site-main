        ...
        <ProSidebar className='proSidebar' collapsed={collapse} toggled={toggle} breakPoint='md' image='/sidebar/sidebar-bg.jpg'>
            ...
            <SidebarFooter>
                <Flex flexDirection={collapse ? 'column' : 'row'} justifyContent='center' alignItems='center' p='20px' mr={!collapse && '30px'}>
                    <Link href="https://github.com/yeshealer" mr={!collapse && '10px'} mb={collapse && '10px'}><Icon icon="bi:github" color="white" width="25" height="25" /></Link>
                    <Link href="https://www.linkedin.com/in/adan-cui-926188232/" mr={!collapse && '10px'} mb={collapse && '10px'}><Icon icon="bi:linkedin" color="white" width="25" height="25" /></Link>
                    <Link href="https://yeshealer.vercel.app" mr={!collapse && '10px'} mb={collapse && '10px'}><Icon icon="ic:round-personal-video" color="white" width="25" height="25" /></Link>
                    ...
                    <Link href="https://t.me/yeshealer"><Icon icon="cib:telegram" color="white" width="25" height="25" /></Link>
                </Flex>
            </SidebarFooter>
            {!collapse && (
            ...
            {collapse && (
                <Button className='proSidebar__collapseBtn' onClick={() => setCollapse(!collapse)}>
                    <lottie-player
                        autoplay
                        loop
                        mode="normal"
